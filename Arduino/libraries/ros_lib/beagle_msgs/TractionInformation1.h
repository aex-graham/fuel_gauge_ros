#ifndef _ROS_beagle_msgs_TractionInformation1_h
#define _ROS_beagle_msgs_TractionInformation1_h
...
namespace beagle_msgs
{
  ...
  class TractionInformation1 : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "beagle_msgs/TractionInformation1"; };
