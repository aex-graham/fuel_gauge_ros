#ifndef _ROS_nova_msgs_HardwareInterfacePortInfo_h
#define _ROS_nova_msgs_HardwareInterfacePortInfo_h
...
namespace nova_msgs
{
  ...
  class HardwareInterfacePortInfo : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "nova_msgs/HardwareInterfacePortInfo"; };
