#ifndef _ROS_greenzie_msgs_FixPositionDriverVRTK_h
#define _ROS_greenzie_msgs_FixPositionDriverVRTK_h
...
namespace greenzie_msgs
{
  ...
  class FixPositionDriverVRTK : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "greenzie_msgs/FixPositionDriverVRTK"; };
