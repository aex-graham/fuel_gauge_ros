#ifndef _ROS_greenzie_msgs_TraversalGraphNode_h
#define _ROS_greenzie_msgs_TraversalGraphNode_h
...
namespace greenzie_msgs
{
  ...
  class TraversalGraphNode : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "greenzie_msgs/TraversalGraphNode"; };
    virtual const char * getMD5() override { return "be26070368a585abad86a5453ccb6325"; };
