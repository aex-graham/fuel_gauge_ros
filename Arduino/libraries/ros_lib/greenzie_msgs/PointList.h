#ifndef _ROS_greenzie_msgs_PointList_h
#define _ROS_greenzie_msgs_PointList_h
...
namespace greenzie_msgs
{
  ...
  class PointList : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "greenzie_msgs/PointList"; };
