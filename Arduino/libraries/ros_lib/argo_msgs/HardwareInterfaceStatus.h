#ifndef _ROS_argo_msgs_HardwareInterfaceStatus_h
#define _ROS_argo_msgs_HardwareInterfaceStatus_h
...
#include "argo_msgs/HardwareInterfacePortInfo.h"
...
namespace argo_msgs
{
  ...
  class HardwareInterfaceStatus : public ros::Msg
  {
    public:
      ...
      typedef argo_msgs::HardwareInterfacePortInfo _aux_ports_type;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(aux_ports_lengthT > aux_ports_length)
        this->aux_ports = (argo_msgs::HardwareInterfacePortInfo*)realloc(this->aux_ports, aux_ports_lengthT * sizeof(argo_msgs::HardwareInterfacePortInfo));
      aux_ports_length = aux_ports_lengthT;
      for( uint32_t i = 0; i < aux_ports_length; i++){
      offset += this->st_aux_ports.deserialize(inbuffer + offset);
        memcpy( &(this->aux_ports[i]), &(this->st_aux_ports), sizeof(argo_msgs::HardwareInterfacePortInfo));
      }
      union {
        bool real;
        uint8_t base;
    ...
    virtual const char * getType() override { return "argo_msgs/HardwareInterfaceStatus"; };
