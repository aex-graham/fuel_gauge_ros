#ifndef _ROS_argo_msgs_TractionInformation2_h
#define _ROS_argo_msgs_TractionInformation2_h
...
namespace argo_msgs
{
  ...
  class TractionInformation2 : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "argo_msgs/TractionInformation2"; };
