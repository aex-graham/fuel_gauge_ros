#ifndef _ROS_argo_msgs_AsiThrottleStatus_h
#define _ROS_argo_msgs_AsiThrottleStatus_h
...
#include "argo_msgs/AsiStatusCode.h"
...
namespace argo_msgs
{
  ...
  class AsiThrottleStatus : public ros::Msg
  {
    public:
      ...
      typedef argo_msgs::AsiStatusCode _asi_status_code_type;
    ...
    virtual const char * getType() override { return "argo_msgs/AsiThrottleStatus"; };
