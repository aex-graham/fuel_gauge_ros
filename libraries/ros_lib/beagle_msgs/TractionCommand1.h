#ifndef _ROS_beagle_msgs_TractionCommand1_h
#define _ROS_beagle_msgs_TractionCommand1_h
...
namespace beagle_msgs
{
  ...
  class TractionCommand1 : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "beagle_msgs/TractionCommand1"; };
