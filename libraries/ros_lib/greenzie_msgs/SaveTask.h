#ifndef _ROS_SERVICE_SaveTask_h
#define _ROS_SERVICE_SaveTask_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SAVETASK[] = "greenzie_msgs/SaveTask";

  class SaveTaskRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SAVETASK; };
    virtual const char * getMD5() override { return "cfe37cdddcaaf5bd95f630c73751773b"; };

  };

  class SaveTaskResponse : public ros::Msg
  {
    public:
  ...
  class SaveTask {
    public:
    typedef SaveTaskRequest Request;
    typedef SaveTaskResponse Response;
  };
